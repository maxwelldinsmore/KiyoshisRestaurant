...
export default function PrivacyPage() {
  return (
    <div className={`${inter.className} min-h-dvh flex flex-col`}>
      ...
      <main className="flex-1 bg-[#f6f6f1]" aria-label="Privacy Policy page">
        <section className="mx-auto max-w-4xl px-4 py-14 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-bold tracking-tight md:text-5xl">Privacy Policy</h1>
          <p className="mt-4 text-base text-stone-600">This is a basic Privacy Policy page. Content coming soon.</p>
        </section>
      </main>
